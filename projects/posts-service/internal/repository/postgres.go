...
// NewPostgresStore создаёт новое подключение к PostgreSQL
...
// CreatePost сохраняет новый пост
...
// ToggleComments включает/выключает комментарии
...
// GetCommentsByPostID возвращает корневые комментарии поста
...
// GetRepliesByParentID возвращает ответы на комментарий
